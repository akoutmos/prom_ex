    ...
    metadata: %{
      ...
      socket: %{
        ...
        assigns: %{
          ...
          system_info: %{
            banner:
              ~c"Erlang/OTP 22 [erts-10.7.2.7] [source] [64-bit] [smp:2:2] [ds:2:2:10] [async-threads:1] [hipe]\n",
            dashboard_version: ~c"0.2.10",
            elixir_version: "1.10.4",
            phoenix_version: ~c"1.5.7",
            system_architecture: ~c"x86_64-pc-linux-gnu"
          },
