[
  ...
  %{
    ...
    metadata: %{
      ...
      queue: "default",
      stacktrace: [
        {WebApp.Jobs.DefaultWorker, :perform, 1, [file: 'lib/web_app/jobs/default_worker.ex', line: 9]},
        {Oban.Queue.Executor, :perform_inline, 1, [file: 'lib/oban/queue/executor.ex', line: 168]},
        {Oban.Queue.Executor, :perform_inline, 1, [file: 'lib/oban/queue/executor.ex', line: 156]},
        {Oban.Queue.Executor, :call, 1, [file: 'lib/oban/queue/executor.ex', line: 79]},
